    ...
    <Form labelCol={{ span: 4 }} wrapperCol={{ span: 18 }}>
      ...
      <Form.Item label="模组生产厂家">
        {getFieldDecorator('moduleBrandId', {
          rules: [{ required: false, message: '请选择模组生产厂家' }],
        })(
      ...
      <Form.Item label="模组型号">
        {getFieldDecorator('hetModuleTypeName', {
          rules: [{ required: false, message: '请输入方案名称', whitespace: true }],
        })(<Input placeholder="请输入方案名称" />)}
      </Form.Item>
      ...
      <Form.Item label="适用范围" >
        {getFieldDecorator("applyScope", {
          rules:
            [{ required: false, message: '请输入模组适用范围' }, { type: 'string', max: 50, message: '上限50个字符长度' }]
        })(
      ...
      <Form.Item style={{ display: 'inline-block', width: '100px', marginBottom: 0 }}>
          {getFieldDecorator("sizeThickness", { initialValue: '', rules: [{ required: false, message: '请输入长' }, { validator: checkNumber }] })(
            <InputNumber maxLength={3} max={999} />
          )}
        </Form.Item>
        <span>&nbsp;-&nbsp;&nbsp;&nbsp;</span>
        <Form.Item label="" style={{ display: 'inline-block', width: '100px', marginBottom: 0 }} >
          {getFieldDecorator("sizeWidth", { initialValue: '', rules: [{ required: false, message: '请输入宽' }, { validator: checkNumber }] })(
            <InputNumber maxLength={3} max={999} />
          )}
        </Form.Item>
        <span>&nbsp;-&nbsp;&nbsp;&nbsp;</span>
        <Form.Item style={{ display: 'inline-block', width: '100px', marginBottom: 0 }} >
          {getFieldDecorator("sizeHeight", { initialValue: '', rules: [{ required: false, message: '请输入高' }, { validator: checkNumber }] })(
            <InputNumber maxLength={3} max={999} />
          )}
        </Form.Item>
        <br />
