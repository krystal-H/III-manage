...
import { Modal, Button, Steps, Form, Input, Select, Radio, Tabs } from 'antd';
import ConfigSchemeBrief from './configSchemeBrief'
import ConfigSchemeDetail from './configSchemeDetail'
import { saveSchemeCategory } from './store/ActionCreators'
...
//   console.log(state.getIn(['categoryInfo']), '----------')
//   return {
//     showCategoryIfo: state.getIn(['categoryInfo'])
//   }
// }

// const mapDispatchToProps = dispatch => {
//   return {
//     saveInfo: params => dispatch(saveSchemeCategory(params))
//   }
// }
...
// export default Form.create()(connect(mapStateToProps, mapDispatchToProps)(OperateSchemeModal))
