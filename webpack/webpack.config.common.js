...
let common = {
  ...
  plugins: [
    ...
    new webpack.ProvidePlugin({
      // _ : 'lodash' //此种写法，会导致整个lodash打包;最好使用import的方式，可以按需引入，减少打包后文件的大小
    }),
    //  It creates a CSS file per JS file which contains CSS.
    new MiniCssExtractPlugin({
      filename: staticPath + `/css/[name].css${fileHash}`,
      ignoreOrder: false
    }),
